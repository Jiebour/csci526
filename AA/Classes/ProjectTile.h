...
class CageProjectTile : public ProjectTile {
public:
    bool initWithTargetPos(cocos2d::CCPoint pos);
    void update(float dt);
    
    static CageProjectTile* create(cocos2d::CCPoint pos);
private:
    //void moveToTargetPos();
    bool initWithMyFile();
    
};
class YummyProjectTile : public ProjectTile {
public:
    bool initWithTargetPos(cocos2d::CCPoint pos);
    void update(float dt);
    
    static YummyProjectTile* create(cocos2d::CCPoint pos);
private:
    //void moveToTargetPos();
    bool initWithMyFile();

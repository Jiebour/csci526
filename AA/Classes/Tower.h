...
class CageTower : public Tower{
public:
    bool initWithFileAndRange(const char *pszFilename, int range);
    bool initWithSpriteFrame(cocos2d::CCSpriteFrame* frame, int range);
    void fire(float dt);
    int killed;
    static CageTower* create();
    static CageTower* create(const char *pszFilename, int range);
    static CageTower* create(cocos2d::CCSpriteFrame* frame, int range);
};
class YummyTower : public Tower{
public:
    bool initWithFileAndRange(const char *pszFilename, int range);
    bool initWithSpriteFrame(cocos2d::CCSpriteFrame* frame, int range);
    void fire(float dt);
    static YummyTower* create();
    static YummyTower* create(const char *pszFilename, int range);
    static YummyTower* create(cocos2d::CCSpriteFrame* frame, int range);
    int killed;
};

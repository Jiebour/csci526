...
bool GameHUD::init(){
	...
	do
	{
       ...
       // CCTexture2D *towers =CCTextureCache::sharedTextureCache()->addImage("enemy.png");
        ...
        CCSpriteFrame *tower4 = gm->getParser4()->SpriteFrameFromFile("frame1", "ui_tower4_normal");//TowerIcon4;
        
        CCSpriteFrame *tower5 =gm->getParser4()->SpriteFrameFromFile("frame1", 181);        //CCSpriteFrame::createWithTexture(towers, CCRectMake(409 ,333, 43 ,62));
        CCSpriteFrame *tower6 =gm->getParser4()->SpriteFrameFromFile("frame1", 182);        //
        ...
        CCArray* frameArr = CCArray::create(tower1,tower2,tower3,tower4,tower5,tower6,NULL);
        towersFrameArr = CCArray::create(Tower1_1,Tower2_1,Tower3_1,Tower4_1,Tower5_1,Tower6_1,NULL);
        CCArray* costArr = CCArray::create(CCString::create(to_string(Tower1Cost)),CCString::create(to_string(Tower2Cost)),CCString::create(to_string(Tower3Cost)),CCString::create(to_string(Tower4Cost)),CCString::create(to_string(Tower5Cost)),CCString::create(to_string(Tower6Cost)),NULL);
		...
		resources = 50;
		resourceLabel = CCLabelTTF::create("Money 50", "Marker Felt", 20, CCSizeMake(150, 25), kCCTextAlignmentRight);

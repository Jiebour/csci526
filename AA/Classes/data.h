...
#define MAXKILL_5 5
#define MAXKILL_6 3
#define Tower1Cost 10
#define Tower2Cost 20
#define Tower3Cost 40
#define Tower4Cost 60
#define Tower5Cost 30
#define Tower6Cost 15
...
#define T5Interval 0.1f
#define T6Interval 0.1f

#define EnemyTexture CCTextureCache::sharedTextureCache()->textureForKey("icon.png")
#define Tower1_1  CCSpriteFrame::createWithTexture(EnemyTexture, CCRectMake(0, 50 ,50, 50))
#define Tower1_2  CCSpriteFrame::createWithTexture(EnemyTexture, CCRectMake(50, 50 ,50, 50))
#define Tower1_3  CCSpriteFrame::createWithTexture(EnemyTexture, CCRectMake(100, 50 ,50, 50))
#define Tower1_4  CCSpriteFrame::createWithTexture(EnemyTexture, CCRectMake(50, 50 ,50, 50))

#define Tower2_1  CCSpriteFrame::createWithTexture(EnemyTexture, CCRectMake(150 ,50 ,50 ,50))
#define Tower2_2  CCSpriteFrame::createWithTexture(EnemyTexture, CCRectMake(200 ,50 ,50 ,50))
#define Tower2_3  CCSpriteFrame::createWithTexture(EnemyTexture, CCRectMake(0 ,100 ,50 ,50))
#define Tower2_4  CCSpriteFrame::createWithTexture(EnemyTexture, CCRectMake(150 ,50 ,50 ,50))

#define Tower3_1  CCSpriteFrame::createWithTexture(EnemyTexture, CCRectMake(50 ,100 ,50 ,50))
#define Tower3_2  CCSpriteFrame::createWithTexture(EnemyTexture, CCRectMake(100 ,100 ,50 ,50))
#define Tower3_3  CCSpriteFrame::createWithTexture(EnemyTexture, CCRectMake(150 ,100 ,50 ,50))
#define Tower3_4  CCSpriteFrame::createWithTexture(EnemyTexture, CCRectMake(50 ,100 ,50 ,50))

#define Tower4_1  CCSpriteFrame::createWithTexture(EnemyTexture, CCRectMake(200 ,100 ,50 ,50))
#define Tower4_2  CCSpriteFrame::createWithTexture(EnemyTexture, CCRectMake(0 ,150 ,50 ,50))
#define Tower4_3  CCSpriteFrame::createWithTexture(EnemyTexture, CCRectMake(50 ,150 ,50 ,50))
#define Tower4_4  CCSpriteFrame::createWithTexture(EnemyTexture, CCRectMake(100 ,100 ,50 ,50))
#define Obstacle CCTextureCache::sharedTextureCache()->textureForKey("icon.png")
#define Tower5_1 CCSpriteFrame::createWithTexture(Obstacle, CCRectMake(100, 200, 50, 50))
#define Tower6_1 CCSpriteFrame::createWithTexture(Obstacle, CCRectMake(150, 200, 50, 50))
...
#define TowerIcon5 CCSpriteFrame::createWithTexture(ICONS, CCRectMake(0 ,200 ,50 ,50))
